...
-   [Voorwoord van de
    vertaler](#voorwoord-van-de-vertaler){#toc-voorwoord-van-de-vertaler}
-   [Inleiding](#inleiding){#toc-inleiding}
-   [Wat is bitcoin?](#wat-is-bitcoin){#toc-wat-is-bitcoin}
    -   [Waar komt bitcoin
        vandaan?](#waar-komt-bitcoin-vandaan){#toc-waar-komt-bitcoin-vandaan}
    -   [Welke problemen lost het
        op?](#welke-problemen-lost-het-op){#toc-welke-problemen-lost-het-op}
-   [De tussenpersoon verwijderen](#chap2){#toc-chap2}
-   [Banken zijn slechts
    grootboeken](#banken-zijn-slechts-grootboeken){#toc-banken-zijn-slechts-grootboeken}
-   [Het
    dubbele-uitgavenprobleem](#het-dubbele-uitgavenprobleem){#toc-het-dubbele-uitgavenprobleem}
-   [Het grootboek delen tussen verschillende
    partijen](#het-grootboek-delen-tussen-verschillende-partijen){#toc-het-grootboek-delen-tussen-verschillende-partijen}
-   [De dubbele-uitgaven
    aanval](#de-dubbele-uitgaven-aanval){#toc-de-dubbele-uitgaven-aanval}
-   [Het oplossen van het gedistribueerd consensus
    probleem](#het-oplossen-van-het-gedistribueerd-consensus-probleem){#toc-het-oplossen-van-het-gedistribueerd-consensus-probleem}
-   [Valse identiteit en
    Sybil-aanvallen](#valse-identiteit-en-sybil-aanvallen){#toc-valse-identiteit-en-sybil-aanvallen}
-   [We starten een
    loterij](#we-starten-een-loterij){#toc-we-starten-een-loterij}
-   [Proof-of-work](#proof-of-work){#toc-proof-of-work}
    -   [Een energie-intensieve asymmetrische
        puzzel](#een-energie-intensieve-asymmetrische-puzzel){#toc-een-energie-intensieve-asymmetrische-puzzel}
    -   [Hashing](#hashing){#toc-hashing}
    -   [Een korte uitleg over
        bits](#een-korte-uitleg-over-bits){#toc-een-korte-uitleg-over-bits}
    -   [Laten we een aantal teksten
        hashen](#laten-we-een-aantal-teksten-hashen){#toc-laten-we-een-aantal-teksten-hashen}
    -   [Hashen om de proof-of-work loterij te
        winnen](#hashen-om-de-proof-of-work-loterij-te-winnen){#toc-hashen-om-de-proof-of-work-loterij-te-winnen}
-   [Mining](#mining){#toc-mining}
    -   [Hoe worden nieuwe bitcoins
        gemaakt?](#hoe-worden-nieuwe-bitcoins-gemaakt){#toc-hoe-worden-nieuwe-bitcoins-gemaakt}
    -   [De blokbeloning](#de-blokbeloning){#toc-de-blokbeloning}
    -   [De halvering](#de-halvering){#toc-de-halvering}
    -   [Beheersen van de uitgifte en het
        blokinterval](#beheersen-van-de-uitgifte-en-het-blokinterval){#toc-beheersen-van-de-uitgifte-en-het-blokinterval}
    -   [Moeilijkheidsaanpassing: consensus over het
        doelnummer](#moeilijkheidsaanpassing-consensus-over-het-doelnummer){#toc-moeilijkheidsaanpassing-consensus-over-het-doelnummer}
    -   [Hash-rate en de dollarwaarde van
        bitcoin](#hash-rate-en-de-dollarwaarde-van-bitcoin){#toc-hash-rate-en-de-dollarwaarde-van-bitcoin}
    -   [Vergoedingen en het einde van
        blokbeloning](#vergoedingen-en-het-einde-van-blokbeloning){#toc-vergoedingen-en-het-einde-van-blokbeloning}
-   [Het grootboek
    beveiligen](#het-grootboek-beveiligen){#toc-het-grootboek-beveiligen}
    -   [Wanneer blokken
        botsen](#wanneer-blokken-botsen){#toc-wanneer-blokken-botsen}
    -   [De enige, echte
        ketting](#de-enige-echte-ketting){#toc-de-enige-echte-ketting}
    -   [Omkeerbaarheid van
        transacties](#omkeerbaarheid-van-transacties){#toc-omkeerbaarheid-van-transacties}
-   [Forks en
    51%-aanvallen](#forks-en-51-aanvallen){#toc-forks-en-51-aanvallen}
    -   [Mining pools](#mining-pools){#toc-mining-pools}
    -   [51%-aanvallen](#aanvallen){#toc-aanvallen}
-   [Accounts zonder
    identiteit](#accounts-zonder-identiteit){#toc-accounts-zonder-identiteit}
    -   [Een bitcoinrekening
        aanmaken](#een-bitcoinrekening-aanmaken){#toc-een-bitcoinrekening-aanmaken}
    -   [Kan je een privésleutel
        raden?](#kan-je-een-privésleutel-raden){#toc-kan-je-een-privésleutel-raden}
    -   [Het saldo
        monitoren](#het-saldo-monitoren){#toc-het-saldo-monitoren}
    -   [Wallets](#wallets){#toc-wallets}
-   [Wie bepaalt de
    regels?](#wie-bepaalt-de-regels){#toc-wie-bepaalt-de-regels}
    -   [Bitcoin-software](#bitcoin-software){#toc-bitcoin-software}
    -   [Wie maakt de
        regels?](#wie-maakt-de-regels){#toc-wie-maakt-de-regels}
    -   [Een splitsing van de regels
        (Forks)](#een-splitsing-van-de-regels-forks){#toc-een-splitsing-van-de-regels-forks}
-   [What's next?](#whats-next){#toc-whats-next}
    -   [Is Bitcoin de MySpace van
        crypto?](#is-bitcoin-de-myspace-van-crypto){#toc-is-bitcoin-de-myspace-van-crypto}
    -   [Gemakkelijker verkoopbaar en grotere
        liquiditeit](#gemakkelijker-verkoopbaar-en-grotere-liquiditeit){#toc-gemakkelijker-verkoopbaar-en-grotere-liquiditeit}
    -   [Aantoonbaar tien jaar \$1000 miljard
        beveiligd](#aantoonbaar-tien-jaar-1000-miljard-beveiligd){#toc-aantoonbaar-tien-jaar-1000-miljard-beveiligd}
    -   [Aanvallen met bestaande rekenkracht
        afslaan](#aanvallen-met-bestaande-rekenkracht-afslaan){#toc-aanvallen-met-bestaande-rekenkracht-afslaan}
    -   [Decentralisatie](#decentralisatie){#toc-decentralisatie}
    -   [Trek de beste ontwikkelaars
        aan](#trek-de-beste-ontwikkelaars-aan){#toc-trek-de-beste-ontwikkelaars-aan}
    -   [Een wereldwijd financieel
        netwerk](#een-wereldwijd-financieel-netwerk){#toc-een-wereldwijd-financieel-netwerk}
    -   [Solide geld](#solide-geld){#toc-solide-geld}
    -   [Toekomstige ontwikkelingen in
        Bitcoin](#toekomstige-ontwikkelingen-in-bitcoin){#toc-toekomstige-ontwikkelingen-in-bitcoin}
    -   [Lightning Netwerk](#lightning-netwerk){#toc-lightning-netwerk}
    -   [Bitcoin in de
        ruimte](#bitcoin-in-de-ruimte){#toc-bitcoin-in-de-ruimte}
-   [Verder lezen](#verder-lezen){#toc-verder-lezen}
-   [Dankwoord](#dankwoord){#toc-dankwoord}
-   [Over de auteur](#over-de-auteur){#toc-over-de-auteur}
