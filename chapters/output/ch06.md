...
weken)[^2], analyseren we de snelheid van uitgifte over de afgelopen
...
In Figuur [1.5](#fig10){reference-type="ref" reference="fig10"} zie je
...
hernieuwbare energie gebruikt.[^3]
...
per byte opgebruikte ruimte in een blok.[^4] Op die manier kan het zijn
...
[^1]: Een Sybil-aanval is een aanval waarin een deelnemer aan een
...
[^2]: De aanpassingsperiode van 2016 blokken is op basis van het beoogde
    blokinterval van 10 minuten; 10 minuten x 2016 blokken = twee weken.
    Het blokinterval werd arbitrair vastgesteld door Satoshi om groot
    genoeg te zijn zodat de meeste nodes kunnen op de hoogte zijn van de
    laatste blok. De periode van twee weken is ook ietwat arbitrair
    gekozen, maar is ontworpen om te voorkomen dat het spel belazerd
    wordt door te snelle achtereenvolgende aanpassingen in de hash-rate.

[^3]: Lees meer over de laatste stand van zaken betreffende mining op
    [https://coinshares.com/research/bitcoin-mining-network-june-2019
    ](https://coinshares.com/research/bitcoin-mining-network-june-2019 )

[^4]: Een byte is 8 bits.
